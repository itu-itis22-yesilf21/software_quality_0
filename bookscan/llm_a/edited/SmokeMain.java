...
/**
 * Phase 2 / Step 4 smoke test for bookscan/llm_a/edited/BookScan.java.
 * The edited prompt pinned the integration API to
 *   scan(List<String> lines, int wordLength) -> Map<String, List<Integer>>
 * so this driver also asserts the spec-defined output for a 5-line text.
 */
